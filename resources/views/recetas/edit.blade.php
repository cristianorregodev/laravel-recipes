...
@section('buttons')
    <a href="{{route('recetas.index')}}" class="btn btn-outline-primary mr-2 font-weight-blod">
...
@section('content')
    <h2 class="text-center">Editar Receta: <span class="text-primary">{{$receta->title}}</span></h2>
        ...
        <div class="col-md-8">
            <form action="{{route('recetas.update', ['receta' => $receta->id])}}" method="post" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-group">
                    ...
                    class="form-control @error('category') is-invalid @enderror">
                        ...
                        @foreach($categories as $category)
                            <option value="{{$category->id}}" {{$receta->category_id == $category->id ? 'selected' : ''}}>{{$category->name}}</option>
                        @endforeach
                    </select>
                    @error('category')
                        <span class="invalid-feedback d-block" role="alert">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="preparation" id="preparation" value="{{$receta->preparation}}">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="ingredients" id="ingredients" value="{{$receta->ingredients}}">
                ...
                <div class="form-group">
                    ...
                    <div class="mt-4">
                        <p>Imagen actual:</p>
                        <img src="/storage/{{$receta->image}}" alt="{{$receta->title}}" width="300px">
                    </div>
